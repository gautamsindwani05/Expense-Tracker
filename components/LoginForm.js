        ...
        <form onSubmit={submitHandler} className="flex flex-col w-full gap-y-4 mt-4 ">
            <label htmlFor="email" className='w-full'>
                <p className='text-[1rem] text-black mb-1 leading-[1.375rem]'>
                    Email Address<sup className='#f4930c'>*</sup>
                </p>
                <input
                    className='bg-gray-700 rounded-[0.5rem] text-black w-full p-[10px] border-b-gray-400 border-b-[3px]'
                    required
                    type="email"
                    id='email'
                    name='email'
            ...
            <label htmlFor="password" className='w-full relative'>
                <p className='text-[1rem] text-black mb-1 leading-[1.375rem]'>
                    Password<sup className='#f4930c'>*</sup>
                </p>
                <input
                ...
                <Link to="#">
                    <p className='text-xs mt-1 text-black-100 max-w-max ml-auto'>Forgot Password</p>
                </Link>
            </label>
